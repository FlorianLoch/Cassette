...
.container
    .jumbotron.mt-4
        ...
        p.lead
            i Cassette for Spotify
            | &nbsp;
            | is a tool trying to give you the same comfort listening to audiobooks on Spotify&#174; as your good, old cassette recorder provided while benefitting from Spotify's large collection and sublime portability.
        p.lead While Spotify provides some functionality for audiobooks in the USA and some other countries, it is not available in many others. The features provided for podcasts would be great for audiobooks - but they are limited to the former.
        p.lead
            i Cassette for Spotify
            | &nbsp;
            | tries to fix that issue for you as good as a third-party tool can! It does that by enabling you to suspend the story you are listening to and resume later without having to take screenshots, note down or simply remember the position every time. And it even get's you right back there when you wish so!
        hr.my-4
        p But before we can start please read the following and give your consent. Don't be afraid of this lengthy text &ndash; but data protection is important to us and we want to clarify how your data is used within Cassette. We take your privacy very serious and refrain from collecting/storing any data from you that is not strictly necessary in order to provide this service. We even take additional measures to anonymize you within our database. There is really nothing surprising going on, promised!
        p In a nutshell: You grant Spotify to grant this service access to your "player state". Cassette reads and writes this state as you request it to do so. The token enabling Cassette to perform these operations is stored only in your browser. Additionally, it's encrypted. Your states are stored in a database hosted by a company called MongoDB. There are no operations performed using your data except the ones stated. You can withdraw your consent at any time. Album arts will be fetched directly from Spotify's servers. As always, this software is offered as-is &ndash; it comes with no more than the minimum liability required by the applicable laws.

        b-button.mt-3.mb-2(v-b-toggle.collapse-moreDetails, size="sm", variant="outline-dark") Want to get additional details or manage your data? Click here!
        b-collapse#collapse-moreDetails.mt-2
            ...
            p Additionally, in order to get an idea about visitor numbers, we use a self-hosted instance of&nbsp;
