...
.container
  .jumbotron.mt-4
    ...
    ul
      ...
      li MongoDB: Your player states are stored in databases hosted by them (on Azure servers located in the Netherlands). Your user name (Spotify user ID) gets anonymised before being written to the database. Anonymisation happens by hashing your user ID, this operation is considered to be irreversible. But having access to the database and knowing your user ID one could prove it is in there. MongoDB incorporated data protection policies into their terms of service already, an additional Data Protection Addendum (DPA) therefore is not necessary.
